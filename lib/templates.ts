...
export const TEMPLATES: Template[] = [
  ...
  },
  {
    ...
    content: ({ author, today }) => [
      ...
      check('할 일 — 담당자 — 기한'),
      quote('액션 아이템은 페이지를 우클릭해 "업무로 전환"하거나, "업무 찾기" 에서 업무로 만들어 담당자·기한을 붙이세요.'),
    ],
  },
  {
    key: 'task',
  ...
  },
  {
    ...
    content: () => [
      ...
      bullet('회의록: 회의록을 조직·기간별로 모아 보고, 여러 건을 한 페이지로 합칠 수도 있습니다'),
      bullet('주간 현황: 지난 7일 각자 남긴 로그를 사람별로 + 주간 정리 문서 — 주간회의는 이 화면으로'),
